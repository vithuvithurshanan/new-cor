  ...
  private shipments: Shipment[] = [
    {
      ...
      pickupAddress: { street: '123 Origin St', city: 'Origin City', state: 'NY', zipCode: '10001', coordinates: { lat: 40.7128, lng: -74.0060 } },
      dropoffAddress: { street: '123 Maple Ave', city: 'Springfield', state: 'IL', zipCode: '62704', coordinates: { lat: 40.7589, lng: -73.9851 } },
      weight: 5.5,
      ...
      events: [
        { status: ShipmentStatus.PLACED, timestamp: '2023-10-23 09:00', description: 'Order placed', coordinates: { lat: 40.7128, lng: -74.0060 } },
        { status: ShipmentStatus.PICKED, timestamp: '2023-10-23 14:00', description: 'Picked up by rider', coordinates: { lat: 40.7128, lng: -74.0060 } },
        { status: ShipmentStatus.IN_TRANSIT, timestamp: '2023-10-24 08:00', description: 'Arrived at regional hub', coordinates: { lat: 40.7300, lng: -73.9950 } }
      ]
    },
    {
      id: 'TRK-992100',
      ...
      pickupAddress: { street: '456 Tech Park', city: 'Tech City', state: 'CA', zipCode: '94000', coordinates: { lat: 37.7749, lng: -122.4194 } },
      dropoffAddress: { street: '45 Corporate Blvd', city: 'Metro City', state: 'NY', zipCode: '10002', coordinates: { lat: 37.8044, lng: -122.2711 } },
      weight: 2.0,
      serviceType: 'EXPRESS',
      ...
      events: [
        { status: ShipmentStatus.PLACED, timestamp: '2023-10-20 10:00', description: 'Order placed', coordinates: { lat: 37.7749, lng: -122.4194 } },
        { status: ShipmentStatus.DELIVERED, timestamp: '2023-10-22 11:30', description: 'Delivered to reception', coordinates: { lat: 37.8044, lng: -122.2711 } }
      ]
    },
    {
      id: 'TRK-774321',
      ...
      pickupAddress: { street: '789 Bat Cave', city: 'Gotham', state: 'NJ', zipCode: '07001', coordinates: { lat: 40.7128, lng: -74.0060 } },
      dropoffAddress: { street: '789 Oak St', city: 'Gotham', state: 'NJ', zipCode: '07002', coordinates: { lat: 40.7589, lng: -73.9851 } },
      weight: 10.0,
