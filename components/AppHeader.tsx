...
export const AppHeader: React.FC<AppHeaderProps> = ({ user, currentView }) => {
  ...
  return (
    <header className="bg-white/80 backdrop-blur-xl border-b border-slate-200 px-6 py-4 shadow-sm">
        ...
        <div className="hidden md:flex flex-1 max-w-md mx-8">
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-slate-100 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all text-slate-800 placeholder-slate-400"
            />
          </div>
        </div>
